...
java -d64 -XX:+UseG1GC -Xms4g -Xmx4g -Xss512k -XX:MaxGCPauseMillis=200 -XX:+DisableExplicitGC -XX:+UseStringDeduplication -XX:+ParallelRefProcEnabled -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+UseGCLogFileRotation -XX:NumberOfGCLogFiles=50 -XX:GCLogFileSize=10m -Xloggc:/tmp/gc/qiuqiu-admin-gc.log -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp/gc/gc_heap.dump -jar qiuqiu-admin-0.0.1-SNAPSHOT.jar >/dev/null 2>&1 &
